...
import { errorMessage, fmtNum, revisionNoteLabel } from '../util';
                  ...
                  <tbody>
                    {data.recheck.map((r) => (
                      <tr key={r.questionId}>
                        ...
                        <td
                          className="dim cell-ellipsis"
                          title={revisionNoteLabel(r.revisionNote) ?? ''}
                        >
                          {revisionNoteLabel(r.revisionNote) ?? '문항 갱신/배점 차이'}
                        </td>
